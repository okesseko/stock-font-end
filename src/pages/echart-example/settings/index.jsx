    ...
    return (
      <div className="flex justify-center mt-10">
        <div className="mr-5 pr-5 border-r">
          <div>
            <div>λ<sub>B</sub>: {this.state.default_lambda_B}</div>
            <input
          ...
          <div>
            <div>R<sub>B</sub>: {this.state.R_B}</div>
            <input
          ...
          <hr className="my-3" />
          <div>
            <div>θ<sub>B</sub>: {this.state.default_theta_B}</div>
            <input
              type="range" min="1" max="20" step="0.1"
          ...
          <div>
            <div>R<sub>B</sub>: {this.state.R_theta_B}</div>
            <input
              type="range" min="0.1" max="5" step="0.1"
          ...
          <hr className="my-3" />
          <div>
            <div>μ<sub>B</sub>: {this.state.mu_B}</div>
            <input
              type="range" min="1" max="20" step="0.1"
        ...
        <div>
          <div>
            <div>λ<sub>A</sub>: {this.state.default_lambda_A}</div>
            <input
              type="range" min="1" max="20" step="0.1"
          ...
          <div>
            <div>R<sub>A</sub>: {this.state.R_A}</div>
            <input
              type="range" min="0.1" max="5" step="0.1"
          ...
          <hr className="my-3" />
          <div>
            <div>θ<sub>A</sub>: {this.state.default_theta_A}</div>
            <input
              type="range" min="1" max="20" step="0.1"
          ...
          <div>
            <div>R<sub>A</sub>: {this.state.R_theta_A}</div>
            <input
              type="range" min="0.1" max="5" step="0.1"
          ...
          <hr className="my-3" />
          <div>
            <div>μ<sub>A</sub>: {this.state.mu_A}</div>
            <input
              type="range" min="1" max="20" step="0.1"
